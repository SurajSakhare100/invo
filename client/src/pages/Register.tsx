...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] flex items-center justify-center px-4 font-sans py-10">
      {/* Background patterns */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-green-100/40 via-transparent to-transparent pointer-events-none" />
      ...
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-3xl shadow-xl p-8 relative overflow-hidden">
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-gray-400 mt-1">Get started with a premium invoice organizer</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <User size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-450" />
              <input
                {...register('name')}
                type="text"
            ...
            {errors.name && (
              <p className="text-xs text-red-555 mt-1">{errors.name.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.confirmPassword && (
              <p className="text-xs text-red-555 mt-1">{errors.confirmPassword.message}</p>
            )}
          </div>
